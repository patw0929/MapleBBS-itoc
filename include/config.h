...
#define SCHOOLNAME      "伙計工作室"            /* 組織名稱 */
#define BBSNAME         "伙計小站"              /* 中文站名 */
#define BBSNAME2        "PartnerBBS"            /* 英文站名 */
#define SYSOPNICK       "站長"          /* sysop 的暱稱 */
#define TAG_VALID       "["BBSNAME2"]To"        /* 身分認證函 token */

#define MYIPADDR        "192.241.215.40"               /* IP address */
#define MYHOSTNAME      "patw.idv.tw"   /* 網路地址 FQDN */

#define HOST_ALIASES    {MYHOSTNAME, MYIPADDR, \
                         "bbs.patw.idv.tw", "patw.twbbs.org", \
                         NULL}
...
#define FN_POSTTEMPLATE "posttemplate"  /* 發文類別 */
...
#define MAX_BBSDPORT    2               /* bbsd 要開幾個 port，隨 BBSD_PORT 而變 */
#define BBSD_PORT       {23 ,3000}      /* bbsd   所用的 port (bbsd.c) */
